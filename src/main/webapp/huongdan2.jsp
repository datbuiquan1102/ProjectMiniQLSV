					...
					<table class="table">
						<thead>
							<tr>
								...
								<th scope="col">THêm GvHD và ĐT</th>

							</tr>
						</thead>
						<tbody>
							<%
							List<HuongDanModel> list = (List<HuongDanModel>) request.getAttribute("LIST_SVNOTEXIST");
							...
							<tr>
								...
								<td><%=hd.getHotensv()%></td>
								<td colspan="2">
									<button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"  onclick="fillvalueSVNotExist('<%=hd.getMasv() %>','<%=hd.getHotensv()%>')">
										Sửa</button>
								</td>
							</tr>
							<%
					...
					<div class="modal-dialog" role="document">
						<form class="modal-content" action="svnotexistsindt" method="post">
							...
							<select class="form-select form-select-lg mb-3" id="modalmagv" name="magv"
								...
								<div class="modal-body">Chọn Giảng Viên Hưỡng Dẫn</div>
							...
							<input value="" type="text" class="form-control"
								 aria-describedby="emailHelp" name="masv"
								readonly="" id="modalmasv">
							<div class="modal-body">Sinh Viên</div>
							<input value="" type="text" class="form-control"
								 aria-describedby="emailHelp" name="tensv" id="modaltensv"
								readonly="">
							...
							<select class="form-select form-select-lg mb-3" id="modalmadt"
								...
								<%List<DeTaiModel> listdt = (List<DeTaiModel>) request.getAttribute("LIST_DETAI");
								for(DeTaiModel dt : listdt){%>
								<option value="<%=dt.getMadt()%>"><%=dt.getTendt() %></option>
								<%} %>
							</select>
