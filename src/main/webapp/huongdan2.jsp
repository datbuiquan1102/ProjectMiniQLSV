...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
            <a class="nav-link" href="huongdan">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Hưỡng Dẫn</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <a class="col-xl-3 col-md-6 mb-4" href="huongdan">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Sinh Viên Đã Nhận Đề Tài</div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Sinh Viên Chưa Nhận Đề Tài</div>
  ...
  for(HuongDanModel hd : list){%>
    ...
    <form class="modal-content" action="hd" method="post">
      ...
      <div class="modal-body">Họ Tên</div>
          <input value="<%=hd.getHotensv() %>" type="text" class="form-control" id="modalhoten" aria-describedby="emailHelp" name = "hoten">
      <div class="modal-body">Chọn Đề Tài</div>
          <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id= "modaltendt">
  <option selected>Open this select menu</option>
  <option value=""><%=hd.getTendt() %></option>
</select>
<div class="modal-body">Nơi Thực Tập</div>
          <input value="<%=hd.getNoithuctap() %>" type="text" class="form-control" id="modalnoithuctap" aria-describedby="emailHelp" name = "hoten">
          <div class="modal-body">Kết quả</div>
          <input value="<%=hd.getKetqua() %>" type="text" class="form-control" id="modaldiem" aria-describedby="emailHelp" name = "hoten">
