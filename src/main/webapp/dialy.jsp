 ...
 %>
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<a class="col-xl-3 col-md-6 mb-4" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
						...
						<a class="col-xl-3 col-md-6 mb-4" data-toggle="collapse"
